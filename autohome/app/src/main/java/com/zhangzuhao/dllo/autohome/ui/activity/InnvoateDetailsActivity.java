 ...
 * 最新页面的详情页面
 */
public class InnvoateDetailsActivity extends AbsBaseActivity {
    ...
    protected int setLayout() {
        return R.layout.activity_innovatedetails;
    }

    @Override
    protected void initViews() {
        mWebView = byView(R.id.innovatedetails_web);
        goBack  =byView(R.id.innovatedetails_backtv);
